...
export const CartItem = ({ item, locale }: CartItemProps) => {
  ...
  return (
    <div className="bg-[var(--color-background)] rounded-lg p-4 border border-[var(--color-border)] hover:shadow-md transition-shadow duration-200">
      <div className="flex items-start space-x-4">
        {/* Product Image */}
        <div className="flex-shrink-0">
          <Link href={`/${locale}/products/${item.product.id}`}>
            <div className="relative w-20 h-20 rounded-lg overflow-hidden bg-[var(--color-background-secondary)]">
        ...
        <div className="flex-1 min-w-0">
          <Link href={`/${locale}/products/${item.product.id}`}>
            <h3 className="text-lg font-semibold text-[var(--color-text)] hover:text-[var(--color-primary)] transition-colors duration-200 line-clamp-2">
              {productName}
            </h3>
          </Link>
        ...
        <div className="flex flex-col items-end space-y-2">
          ...
          <Button
            ...
            className="text-[var(--color-error)] hover:text-[var(--color-error)] hover:bg-[var(--color-error-light)] border-[var(--color-error)] hover:border-[var(--color-error)]"
          >
